...
.gb-tag--progression { background: var(--cat-progression-tint); color: var(--cat-progression); }
.gb-tag--competition { background: var(--cat-competition-tint); color: var(--cat-competition); }
.gb-tag--customization { background: var(--cat-customization-tint); color: var(--cat-customization); }
.gb-tag--engagement { background: var(--cat-engagement-tint); color: var(--cat-engagement); }
.gb-tag--reach { background: var(--cat-reach-tint); color: var(--cat-reach); }
...
.gb-tag--outline.gb-tag--progression { border-color: var(--cat-progression); }
.gb-tag--outline.gb-tag--competition { border-color: var(--cat-competition); }
.gb-tag--outline.gb-tag--customization { border-color: var(--cat-customization); }
.gb-tag--outline.gb-tag--engagement { border-color: var(--cat-engagement); }
.gb-tag--outline.gb-tag--reach { border-color: var(--cat-reach); }
`);
