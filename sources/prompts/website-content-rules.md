...
14. The overview is two to four sentences about how the app combines its mechanics into a system, opening on the app's most distinctive design tension or insight. A reader should want to know how the app works after the first two sentences. Any single mechanic's accounting details belong in that mechanic's section, never in the overview. Enticing stays within the calm analyst voice: sharp framing, no hype.
...
19. Session events are narrated in first person plural, as our experience: "we already met the goal on the first screen; Wakeout had pulled our Apple Health history and our analyst had been on the move that day." Clinical third person is banned: "the account observed", "the user was shown", "shown to them". "Our analyst" may be referenced when a personal detail explains an observation. Editorial color ("Interestingly,") is allowed sparingly.
20. Numbers serve a point. State the numbers that carry the design insight and summarize the rest ("the other levels scale both numbers together"). Never enumerate full value tables. Every paragraph must leave the reader a conclusion they can reuse.
21. Do not spend sentences on what something is not, unless the absence is itself the insight. Fold such facts into the flow of what it is.
